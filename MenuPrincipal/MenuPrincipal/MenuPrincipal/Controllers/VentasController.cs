	...
	public class VentasController
	{
		...
		public void cambiar(DataGridView dgv)
		{
			...
			{	
				...
				string sqlchange=string.Format("UPDATE productos SET vendido = 1 WHERE id_productos={0}",clave);
		...
		public void insertar(DataGridView dgv,TextBox txt, string TEXT,Label lvl, string empleado)
		{
			...
			string sqlchang=string.Format("INSERT INTO ventas(id_venta,id_empleado,Fecha_venta,total) VALUES ('{0}','{1}','{2}',{3})",idventa,empleado,TEXT,tove);
